...
def setup_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(h_admin.mass_send_process_command, content_types=['photo', 'text', 'video', 'animation'], state=[AppStates.STATE_MASS_SEND_BUTTONS, AppStates.STATE_MASS_SEND_MESSAGE])
